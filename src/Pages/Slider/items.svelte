  ...
  export const data = [
    {
      id: 1,
      question:
        "Beholder jeg mit nuværende mobilnummer i den nye One+ løsning?",
      answers: [
        {
          correct: true,
          text: "Ja - med mindre din arbejdsgiver fravælger det",
        },
        {
          correct: false,
          text: "Nej - vi bliver nødsaget til at give dig et nyt nummer",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      answers: [
        ...
        {
          correct: false,
          text: "Måske, det afhænger hvilket abonnement din virksomhed",
        },
      ],
    },
    {
    ...
    },
    {
      id: 5,
      question:
        "Hvor mange datadelingskort kan man på mobilabonnementet: Mobil Premium?",
      answers: [
    ...
    },
    {
      id: 6,
      question:
        "Har alle abonnementerne følgende feature >fri tale, sms og mms<?",
      answers: [
